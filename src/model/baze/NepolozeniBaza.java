...
public class NepolozeniBaza {
	...
	public void initNepolozene() {
		...
		this.predmet = StudentBaza.getInstance().getRow(PrikazStudenta.getInstance().getTable().convertRowIndexToModel(r)).getNepolozeno();
	...
	public String getValueAt(int row, int column) {
		...
		switch(column) {
			...
			case 2: return String.valueOf(p.getEspb());
			case 3: return String.valueOf(p.getGodina());
			case 4: return String.valueOf(p.getSemestar());
			default: return null;
